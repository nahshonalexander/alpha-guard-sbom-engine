...
try:
    config = anchore_utils.init_query_cmdline(sys.argv, "params: <package name> <package name> ...\nhelp: use 'all' to show all packages")
...
try:
    ...
    pkgdetail_data = anchore_utils.load_analysis_output(config['imgid'], 'package_list', 'pkgs.python')
