...
# main routine
try:
    config = anchore_utils.init_query_cmdline(sys.argv, "params: <filename> <filename> ...\nhelp: use 'all' to show all content search match filenames")
...
try:
    ...
    results = anchore_utils.load_analysis_output(imageId, 'content_search', 'regexp_matches.all')
