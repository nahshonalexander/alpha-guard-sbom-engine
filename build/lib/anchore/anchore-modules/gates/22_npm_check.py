...
# do somthing
try:
    pkgdetail_data = anchore_utils.load_analysis_output(imgid, 'package_list', 'pkgs.npms')
    if pkgdetail_data:
        feeddata = anchore_feeds.load_anchore_feed('packages', 'npm', ensure_unique=True)
