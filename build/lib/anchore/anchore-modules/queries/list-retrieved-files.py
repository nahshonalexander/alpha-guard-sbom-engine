...
try:
    ...
    namespaces = anchore_utils.load_files_namespaces(config['imgid'])
    for namespace in namespaces:
        stored_files = anchore_utils.load_files_metadata(config['imgid'], namespace)
