...
allimages = {}
image = anchore_image.AnchoreImage(config['imgid'], allimages=allimages)
...
compareimage = anchore_image.AnchoreImage(compareto, allimages=allimages)
...
try:
    ...
    nonpkgfilesdict = anchore_utils.load_analysis_output(config['imgid'], 'file_list', 'files.nonpkged')

    cnonpkgfilesdict = anchore_utils.load_analysis_output(compareimage.meta['imageId'], 'file_list', 'files.nonpkged')
